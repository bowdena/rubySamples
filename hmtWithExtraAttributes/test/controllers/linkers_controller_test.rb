...
class LinkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create linker" do
    assert_difference('Linker.count') do
      post linkers_url, params: { linker: { article_id: @linker.article_id, relevance: @linker.relevance, topic_id: @linker.topic_id } }
    end
  ...
  test "should update linker" do
    patch linker_url(@linker), params: { linker: { article_id: @linker.article_id, relevance: @linker.relevance, topic_id: @linker.topic_id } }
